...
complete -c atuin -n "__fish_seen_subcommand_from history; and __fish_seen_subcommand_from start" -l version -d 'Print version information'
...
complete -c atuin -n "__fish_seen_subcommand_from history; and __fish_seen_subcommand_from end" -l version -d 'Print version information'
...
complete -c atuin -n "__fish_seen_subcommand_from history; and __fish_seen_subcommand_from list" -l version -d 'Print version information'
...
complete -c atuin -n "__fish_seen_subcommand_from history; and __fish_seen_subcommand_from last" -l version -d 'Print version information'
...
complete -c atuin -n "__fish_seen_subcommand_from history; and __fish_seen_subcommand_from help" -l version -d 'Print version information'
complete -c atuin -n "__fish_seen_subcommand_from history; and __fish_seen_subcommand_from help" -s h -l help -d 'Print help information'
complete -c atuin -n "__fish_seen_subcommand_from import; and not __fish_seen_subcommand_from auto; and not __fish_seen_subcommand_from zsh; and not __fish_seen_subcommand_from bash; and not __fish_seen_subcommand_from resh; and not __fish_seen_subcommand_from fish; and not __fish_seen_subcommand_from help" -s h -l help -d 'Print help information'
complete -c atuin -n "__fish_seen_subcommand_from import; and not __fish_seen_subcommand_from auto; and not __fish_seen_subcommand_from zsh; and not __fish_seen_subcommand_from bash; and not __fish_seen_subcommand_from resh; and not __fish_seen_subcommand_from fish; and not __fish_seen_subcommand_from help" -f -a "auto" -d 'Import history for the current shell'
complete -c atuin -n "__fish_seen_subcommand_from import; and not __fish_seen_subcommand_from auto; and not __fish_seen_subcommand_from zsh; and not __fish_seen_subcommand_from bash; and not __fish_seen_subcommand_from resh; and not __fish_seen_subcommand_from fish; and not __fish_seen_subcommand_from help" -f -a "zsh" -d 'Import history from the zsh history file'
complete -c atuin -n "__fish_seen_subcommand_from import; and not __fish_seen_subcommand_from auto; and not __fish_seen_subcommand_from zsh; and not __fish_seen_subcommand_from bash; and not __fish_seen_subcommand_from resh; and not __fish_seen_subcommand_from fish; and not __fish_seen_subcommand_from help" -f -a "bash" -d 'Import history from the bash history file'
complete -c atuin -n "__fish_seen_subcommand_from import; and not __fish_seen_subcommand_from auto; and not __fish_seen_subcommand_from zsh; and not __fish_seen_subcommand_from bash; and not __fish_seen_subcommand_from resh; and not __fish_seen_subcommand_from fish; and not __fish_seen_subcommand_from help" -f -a "resh" -d 'Import history from the resh history file'
complete -c atuin -n "__fish_seen_subcommand_from import; and not __fish_seen_subcommand_from auto; and not __fish_seen_subcommand_from zsh; and not __fish_seen_subcommand_from bash; and not __fish_seen_subcommand_from resh; and not __fish_seen_subcommand_from fish; and not __fish_seen_subcommand_from help" -f -a "fish" -d 'Import history from the fish history file'
complete -c atuin -n "__fish_seen_subcommand_from import; and not __fish_seen_subcommand_from auto; and not __fish_seen_subcommand_from zsh; and not __fish_seen_subcommand_from bash; and not __fish_seen_subcommand_from resh; and not __fish_seen_subcommand_from fish; and not __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c atuin -n "__fish_seen_subcommand_from import; and __fish_seen_subcommand_from auto" -l version -d 'Print version information'
...
complete -c atuin -n "__fish_seen_subcommand_from import; and __fish_seen_subcommand_from zsh" -l version -d 'Print version information'
...
complete -c atuin -n "__fish_seen_subcommand_from import; and __fish_seen_subcommand_from bash" -l version -d 'Print version information'
...
complete -c atuin -n "__fish_seen_subcommand_from import; and __fish_seen_subcommand_from resh" -l version -d 'Print version information'
...
complete -c atuin -n "__fish_seen_subcommand_from import; and __fish_seen_subcommand_from fish" -l version -d 'Print version information'
...
complete -c atuin -n "__fish_seen_subcommand_from import; and __fish_seen_subcommand_from help" -l version -d 'Print version information'
complete -c atuin -n "__fish_seen_subcommand_from import; and __fish_seen_subcommand_from help" -s h -l help -d 'Print help information'
...
complete -c atuin -n "__fish_seen_subcommand_from server; and __fish_seen_subcommand_from start" -s h -l host -d 'The host address to bind' -r
...
complete -c atuin -n "__fish_seen_subcommand_from server; and __fish_seen_subcommand_from start" -l version -d 'Print version information'
...
complete -c atuin -n "__fish_seen_subcommand_from server; and __fish_seen_subcommand_from help" -l version -d 'Print version information'
complete -c atuin -n "__fish_seen_subcommand_from server; and __fish_seen_subcommand_from help" -s h -l help -d 'Print help information'
complete -c atuin -n "__fish_seen_subcommand_from stats; and not __fish_seen_subcommand_from all; and not __fish_seen_subcommand_from day; and not __fish_seen_subcommand_from help" -s h -l help -d 'Print help information'
complete -c atuin -n "__fish_seen_subcommand_from stats; and not __fish_seen_subcommand_from all; and not __fish_seen_subcommand_from day; and not __fish_seen_subcommand_from help" -f -a "all" -d 'Compute statistics for all of time'
complete -c atuin -n "__fish_seen_subcommand_from stats; and not __fish_seen_subcommand_from all; and not __fish_seen_subcommand_from day; and not __fish_seen_subcommand_from help" -f -a "day" -d 'Compute statistics for a single day'
complete -c atuin -n "__fish_seen_subcommand_from stats; and not __fish_seen_subcommand_from all; and not __fish_seen_subcommand_from day; and not __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c atuin -n "__fish_seen_subcommand_from stats; and __fish_seen_subcommand_from all" -l version -d 'Print version information'
complete -c atuin -n "__fish_seen_subcommand_from stats; and __fish_seen_subcommand_from all" -s h -l help -d 'Print help information'
complete -c atuin -n "__fish_seen_subcommand_from stats; and __fish_seen_subcommand_from day" -l version -d 'Print version information'
complete -c atuin -n "__fish_seen_subcommand_from stats; and __fish_seen_subcommand_from day" -s h -l help -d 'Print help information'
complete -c atuin -n "__fish_seen_subcommand_from stats; and __fish_seen_subcommand_from help" -l version -d 'Print version information'
complete -c atuin -n "__fish_seen_subcommand_from stats; and __fish_seen_subcommand_from help" -s h -l help -d 'Print help information'
...
complete -c atuin -n "__fish_seen_subcommand_from init; and __fish_seen_subcommand_from zsh" -l version -d 'Print version information'
...
complete -c atuin -n "__fish_seen_subcommand_from init; and __fish_seen_subcommand_from bash" -l version -d 'Print version information'
...
complete -c atuin -n "__fish_seen_subcommand_from init; and __fish_seen_subcommand_from fish" -l version -d 'Print version information'
...
complete -c atuin -n "__fish_seen_subcommand_from init; and __fish_seen_subcommand_from help" -l version -d 'Print version information'
complete -c atuin -n "__fish_seen_subcommand_from init; and __fish_seen_subcommand_from help" -s h -l help -d 'Print help information'
