...
return {
  ...
  -- ABSOLUTE VALUE
  s({ trig = "([^%a])abs", regTrig = true, wordTrig = false, snippetType = "autosnippet" },
    fmta(
      "<>\\lvert <> \\rvert <>",
      {
        f(function(_, snip) return snip.captures[1] end),
  ...
  -- NORM
  s({ trig = "([^%a])norm", regTrig = true, wordTrig = false, snippetType = "autosnippet" },
    fmta(
      "<>\\lVert <> \\rVert<>",
      {
        f(function(_, snip) return snip.captures[1] end),
  ...
  -- MIXED PARTIALS
  s({ trig = "([^%a])pvm", wordTrig = false, regTrig = true, snippetType = "autosnippet" },
    fmta(
  ...
  -- EVAL with upper and lower limit
  s({ trig = "([^%a])evv", wordTrig = false, regTrig = true, snippetType = "autosnippet" },
    fmta(
      "<>\\eval{<>}_{<>}^{<>}",
      {
        f(function(_, snip) return snip.captures[1] end),
  ...
  -- HDOTS, i.e. \hdots
  s({ trig = "hdd", snippetType = "autosnippet" },
    {
      t("\\hdots"),
    }
  ),
